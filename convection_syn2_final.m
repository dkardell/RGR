%file:   convection_syn2.m

%author:  Dominik A. Kardell, modified from Evan J. Ramos
%date:    15 Aug 2020

%Convection script for 3-layer model with line1A thickness sediment layer

clear, clc, close all

load phys_props_syn2.mat %Import physical property grids
...
figure(4)
    set(gcf,'units','normalized','outerposition',[0.2 0 0.2 0.5]) %[0 0 1 0.9]
    subplot(3,1,1)
...
figure(5)
set(gcf,'units','normalized','outerposition',[0.1 0 0.1 0.5]) %[0 0 1 0.9]
    subplot(5,1,1)
    plot(T_top)
